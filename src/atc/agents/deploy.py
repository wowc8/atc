...
def _build_tower_instructions_md(spec: TowerDeploySpec) -> str:
    ...
    lines.extend(
        [
            ...
            "4. If progress shows `prompt_not_submitted`, `kickoff_unverified`,",
            "   or no task graph activity",
            "   after startup, send ONE short prompt-submit nudge:",
            "   `atc leader message --project-id <id> --message "
            "'Please read your goal, inspect the task graph, and continue.'`",
            "5. Continue monitoring with the same progress endpoint.",
            "",
