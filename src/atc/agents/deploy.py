...
def _build_manager_instructions_md(spec: ManagerDeploySpec) -> str:
    ...
    lines = [
        ...
        "```",
        "Poll this every 30s. When `all_done` is true, proceed to review.",
        "",
        ...
        "```",
        "",
        "#### Step 9 — Report completion to Tower",
        "",
        "When all tasks are marked done, summarize what was built and where the output files are.",
        "",
...
def _build_tower_instructions_md(spec: TowerDeploySpec) -> str:
    ...
    lines.extend(
        [
            ...
            "7. Continue monitoring with the same progress endpoint.",
            "",
